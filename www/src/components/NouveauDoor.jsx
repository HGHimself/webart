...
import nouveaDoor from "../vectors/nouveau-door.js";
...
export default function Vector(props) {
  ...
  const optionsToSkip = ["numbers", "height", "width", "amplitudeMultiplier", "hideProps", "omega"];
  ...
  return (
    ...
    <FlexRow flex="space-around">
      <Animator drawer={nouveaDoor} setVis={setVis} options={options} />
    </FlexRow>
  </div>
  );
}